...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    var firstCategoryId = await queryInterface.bulkInsert('categories', categories);
    ...
    await queryInterface.bulkInsert('sessions', [{
      user_id: getId(firstUserId, users, 'provider_user_id', '22222222222222222222222222222'),
      title : 'סדנת הכנת פיצה',
      description: 'הצטרפו אלי לסדנה בה אנסה ללמד אתכם את מתכון הפיצה המשפחתי שלי. מומלץ לצפות מהמטבח כדי שתוכלו להכין יחד איתי 😊 תרגישו חופשי לשאול שאלות בזמן הסדנה!',
